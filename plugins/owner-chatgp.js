...
const handler = async (m, {conn, text, groupMetadata}) => {
  ...
  const fakegif = {key: {participant: `0@s.whatsapp.net`, ...('54 9 260 420-0949-54 9 260 420-0949@g.us' ? {remoteJid: '54 9 260 420-0949-54 9 260 420-0949@g.us'} : {})}, message: {'videoMessage': {'title': '🐱⸽⃕NʏᴀɴCᴀᴛBᴏᴛ - MD🍁⃨፝⃕✰', 'h': `Hmm`, 'seconds': '99999', 'gifPlayback': 'true', 'caption': '🧿 Gogeta - 𝙱ot 🔮', 'jpegThumbnail': false}}};

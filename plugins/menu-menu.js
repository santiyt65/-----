...
${conn.user.jid == global.conn.user.jid ? '╭─────────────⦁\n│╭────────────\n││◉ ➪ BOT OFC: REGALO BY TEAM\n│╰────────────\n╰─────────────⦁' : `╭─────────────⦁
│╭────────────
││◉ ➪ 𝖲𝖴𝖡 𝖡𝖮𝖳: @${global.conn.user.jid.split`@`[0]}
│╰────────────
╰─────────────⦁`}
...
┃👑 *Creador:* sinombre913 
┃✨️ *Número Owner:* 
┃✨️ wa.me/5213331199136
┃-------➫┇◦✦◦✦◦✦◦✦◦┋:̖́-
┃👑 *Número Soporte*
┃✨️ wa.me/5213339577315
┃-------➫┇◦✦◦✦◦✦◦✦◦┋:̖́-
...
handler.command = /^(|comandos|allmenu|2help|menu1.2|ayuda|commands|commandos|cmd)$/i;
handler.exp = 50;
handler.fail = null;
